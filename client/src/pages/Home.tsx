              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    />
                    {/* Quote bubble */}
                    <div className="absolute bottom-3 right-3 max-w-[80%] bg-white/90 backdrop-blur-sm p-3 rounded-lg shadow-lg transform transition-all duration-300 hover:scale-105">
            ...
            >
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb1">
                      Nombre
                    </label>
                    <input
                      type="text"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Desarrollo Web y Móvil</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Av. Principal 123, Ciudad Empresarial, Buenos Aires, Argentina</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">+54 11 1234 5678</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">info@tuempresa.com</a></li>
              </ul>
            </div>
          </div>
