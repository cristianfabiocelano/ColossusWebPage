        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            <a href="#" className="flex items-center">
              ...
              <span className="font-bold text-[#1E3D59]">Colossus</span>
            </a>
            <div className="hidden md:flex space-x-8">
              <button 
                onClick={() => scrollToSection('services')} 
                className="text-gray-600 hover:text-[#F15A24] transition-colors"
              >
                Servicios
              </button>
              <button 
            ...
            <button
              className="hidden md:block bg-[#F15A24] hover:bg-[#F15A24]/90 text-white px-4 py-2 rounded-md"
              onClick={() => scrollToSection('contact')}
            >
              Comienza Ahora
            </button>
